...
<div class="utama">
    <h1 style="position: relative; left:20px; top:40px; font-size: 30px">
        <i class="fa-solid fa-pen-to-square"></i> Input Barang

        <?php
        // fungsi untuk membuat id transaksi
        $query_id = mysqli_query($koneksi, "SELECT RIGHT(id_barang,3) as kode FROM barang
        ...
        <form action="aksi.php?act=insert" method="post">
            ...
            <div class="form-group row pt-4 fs-6">
                ...
                <div class=" col-sm-4">
                    <div class="input-group">
                        <span class="input-group-text" id="basic-addon1">Rp.</span>
                        <input type="text" class="form-control" id="harga_jualsatuan" name="harga_jualsatuan" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" required>
                    </div>
                </div>
            </div>
